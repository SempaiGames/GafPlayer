...
import com.sempaigames.gafplayer.display.spritesimpl.GAFSprite;
import com.sempaigames.gafplayer.display.tilesheetsimpl.GAFSpriteTilesheet;
...
class Main {
	...
	public static function main () {
		var p = Parser.loadFromFile("assets/obrero-01-lineal.gaf");
		//sprA = new GAFSpriteTilesheet(p);
		sprB = new GAFSprite(p);
		//sprA.playLoop(1, sprA.getFrameCount());
		sprB.playLoop(1, sprB.getFrameCount());
